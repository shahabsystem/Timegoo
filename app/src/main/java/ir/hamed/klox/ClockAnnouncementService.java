...
public class ClockAnnouncementService extends Service {
    ...
    @Override public void onCreate() {
        ...
        b.setContentTitle("سخنگوی ساعت").setContentText("در حال اعلام ساعت…").setCustomContentView(rv).setContentView(rv).setSmallIcon(R.mipmap.ic_launcher_modern).setOngoing(true).setOnlyAlertOnce(true);
