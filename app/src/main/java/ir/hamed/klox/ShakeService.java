...
public class ShakeService extends Service implements SensorEventListener {
    ...
    @Override public void onCreate() {
        ...
        b.setContentTitle("تايمگو").setContentText("اعلام ساعت با تکان دادن فعال است").setSmallIcon(R.drawable.ic_status_clock).setOngoing(true).setOnlyAlertOnce(true);
